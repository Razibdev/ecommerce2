        ...
        <div class="row">
            <div class="col-xl-5 col-lg-5 col-md-6">
                <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        @foreach ($ProductAllImages as $key => $images)
            ...
            <form name="addtoCart" method="POST" action="{{url('/add-cart')}}">{{csrf_field()}}
                ...
                <input type="hidden" id="price" name="price" value="{{$productDetails->price}}"/>
                    ...
                    <h5 id="getPrice"> $ {{$productDetails->price}}</h5>
                        ...
                        <p>
                            ...
                            <div class="price-box-bar">
                                <div class="cart-and-bay-btn">
                                    ...
                                    <button style="color: white;" class="btn hvr-hover" data-fancybox-close="" type="submit">Add to cart</button>
                                </div>
                            </div>
