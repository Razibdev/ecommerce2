        ...
        <div class="col-sm-12">
            ...
            <form class="col-sm-6" action="{{url('/admin/edit-category/'.$categoryDetails->id)}}" method="post">{{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$categoryDetails->url}}" id="category_url" name="category_url" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="reset-button">
                        <input type="submit" value="Edit Cateory" class="btn btn-success">
                    </div>
                </form>
            </div>
            </div>
