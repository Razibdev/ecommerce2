            ...
            <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                ...
                <div class="table-responsive">
                    <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                        ...
                        <td>{{$coupon->amount}} @if ($coupon->amount_type == "Percentage") % @else PKR @endif
                        </td>
                        ...
                        <td>{{$coupon->created_at}}</td>
                            ...
                            <td>
                                <input type="checkbox" class="CouponStatus btn btn-success" rel="{{$coupon->id}}" data-toggle="toggle" data-on="Enable" data-off="Disabled" data-onstyle="success" data-offstyle="danger" @if ($coupon['status'] == "1") checked @endif >
